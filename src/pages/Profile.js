...
const Profile = () => {
  ...
  return (
    <>
      ...
      <Container class1='my-profile-wrapper home-wrapper-2 py-5' style={{ backgroundColor: '#7985c9' }}>
        <div className='row'>
          <div className='col-12'>
            <div className='my-profile-card'>
              <div>
                <h3 className='my-3 section-heading text-center'>Hồ sơ của tôi</h3>
                <div className='d-flex align-items-center gap-3 mb-3'>
                  {/* <FiEdit className='fs-3' onClick={() => setEdit(false)} title='Chỉnh sửa thông tin' /> */}
                  <p onClick={() => setEdit(false)} className='btn-change-password mb-0 w-50 text-center'>Sửa thông tin</p>
                  <Link to='/change-password' className='btn-change-password w-50 text-center'>Đổi mật khẩu?</Link>
                </div>
              </div>
              <div>
                <form
